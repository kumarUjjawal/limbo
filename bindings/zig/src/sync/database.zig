...
///
/// This type exposes the raw sync operation and IO queue lifecycle. Higher-level
/// blocking replica APIs can be layered on top of it later without changing the
